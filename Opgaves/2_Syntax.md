...
## 2.2 Parameters
Na het eigenlijke commando kan je ook nog extra info meegeven aan de cmdlet in de vorm van 1 of meerdere parameters (die al dan niet een bepaalde waarde meekrijgen). Een parameter wordt altijd voorafgegaan door een koppelteken `-`
